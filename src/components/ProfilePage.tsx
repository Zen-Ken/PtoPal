...
interface ProfilePageProps {
  ...
  currentPTO: number;
  accrualRate: number;
  onUpdateSettings: (pto: number, accrual: number, payPeriod: string) => void;
}

export default function ProfilePage({ onBack, currentPTO, accrualRate, onUpdateSettings }: ProfilePageProps) {
  ...
  const handleSave = () => {
    onUpdateSettings(formData.currentPTO, formData.accrualRate, formData.payPeriod);
    setIsSaved(true);
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) => setFormData({...formData, currentPTO: Number(e.target.value)})}
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) => setFormData({...formData, annualAllowance: Number(e.target.value)})}
                      className="w-full px-4 py-3 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white/50 backdrop-blur-sm transition-all duration-200"
                      min="0"
                      placeholder="25"
                    />
